...
--   atlas, and since #1259 compiled unit-animation atlases), the
--   sampler recorded for it in @btsPinned@. Either way the sampler
--   comes from the shared refcounted cache, never from this record.
