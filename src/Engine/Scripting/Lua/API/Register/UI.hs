...
registerUIAPI env = do
  ...
  registerLuaFunction "setControlFocus"   (uiSetControlFocusFn env)
  registerLuaFunction "clearControlFocus" (uiClearControlFocusFn env)
  registerLuaFunction "getControlFocus"   (uiGetControlFocusFn env)
  registerLuaFunction "hasControlFocus"   (uiHasControlFocusFn env)
  ...
  registerLuaFunction "setPointerBlocking" (uiSetPointerBlockingFn env)
  ...
  registerLuaFunction "setSpriteFrame" (uiSetSpriteFrameFn env)
