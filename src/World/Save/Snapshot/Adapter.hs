...
pageToWorldPageSave cam nextBid nextUid page = WorldPageSave
    ...
    , wpsPendingChopMigration = pgsPendingChopMigration page
    , wpsPendingFloraHarvests = pgsPendingFloraHarvests page
    , wpsPlantedFloraCursor = pgsPlantedFloraCursor page
    , wpsCraftBills   = pgsCraftBills page
    , wpsTransferOrders = pgsTransferOrders page
