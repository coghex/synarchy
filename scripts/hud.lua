...
function hud.init(boxTexSet, menuFont, width, height)
    ...
    -- Load HUD textures
    hud.texMapDefault         = engine.loadTexture("assets/textures/ui/hud/map_default.png")
    hud.texMapDefaultSelected = engine.loadTexture("assets/textures/ui/hud/map_default_selected.png")
    hud.texMapTemp            = engine.loadTexture("assets/textures/ui/hud/map_temp.png")
    hud.texMapTempSelected    = engine.loadTexture("assets/textures/ui/hud/map_temp_selected.png")
    hud.texMapSeaTemp         = engine.loadTexture("assets/textures/ui/hud/map_seatemp.png")
    hud.texMapSeaTempSelected = engine.loadTexture("assets/textures/ui/hud/map_seatemp_selected.png")
    hud.texMapPressure        = engine.loadTexture("assets/textures/ui/hud/map_pressure.png")
    hud.texMapPressureSelected = engine.loadTexture("assets/textures/ui/hud/map_pressure_selected.png")
    hud.texMapHumidity        = engine.loadTexture("assets/textures/ui/hud/map_humidity.png")
    hud.texMapHumiditySelected = engine.loadTexture("assets/textures/ui/hud/map_humidity_selected.png")
    hud.texMapPrecipitation        = engine.loadTexture("assets/textures/ui/hud/map_precipitation.png")
    hud.texMapPrecipitationSelected = engine.loadTexture("assets/textures/ui/hud/map_precipitation_selected.png")
    hud.texMapPrecipType       = engine.loadTexture("assets/textures/ui/hud/map_preciptype.png")
    hud.texMapPrecipTypeSelected = engine.loadTexture("assets/textures/ui/hud/map_preciptype_selected.png")
    hud.texMapEvaporation       = engine.loadTexture("assets/textures/ui/hud/map_evaporation.png")
    hud.texMapEvaporationSelected = engine.loadTexture("assets/textures/ui/hud/map_evaporation_selected.png")
    hud.texToolDefault         = engine.loadTexture("assets/textures/ui/hud/tool_default.png")
    hud.texToolDefaultSelected = engine.loadTexture("assets/textures/ui/hud/tool_default_selected.png")
    hud.texToolInfo            = engine.loadTexture("assets/textures/ui/hud/tool_info.png")
    hud.texToolInfoSelected    = engine.loadTexture("assets/textures/ui/hud/tool_info_selected.png")
    hud.texToolMine            = engine.loadTexture("assets/textures/ui/hud/tool_mine.png")
    ...
    hud.texEventLog         = engine.loadTexture("assets/textures/ui/hud/event_log.png")
    hud.texEventLogSelected = engine.loadTexture("assets/textures/ui/hud/event_log_selected.png")
    hud.texCombatLog         = engine.loadTexture("assets/textures/ui/hud/combat_log.png")
    hud.texCombatLogSelected = engine.loadTexture("assets/textures/ui/hud/combat_log_selected.png")
    hud.texInjuryLog         = engine.loadTexture("assets/textures/ui/hud/injury_log.png")
    hud.texInjuryLogSelected = engine.loadTexture("assets/textures/ui/hud/injury_log_selected.png")
