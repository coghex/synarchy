...
local worldStructuralPaths = {
    ...
    "assets/textures/facemap/isoface_level_1.png",
    "assets/textures/facemap/isoface_level_2.png",
    "assets/textures/facemap/isoface_level_3.png",
    "assets/textures/facemap/isoface_level_4.png",
    "assets/textures/facemap/isoface_level_5.png",
    "assets/textures/facemap/isoface_level_6.png",
    "assets/textures/facemap/isoface_level_7.png",
    "assets/textures/facemap/isoface_level_8.png",
