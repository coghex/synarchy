...
function shell.init(scriptId)
    ...
    texBox = engine.loadTexture("assets/textures/ui/box/box.png")
    texBoxN = engine.loadTexture("assets/textures/ui/box/boxn.png")
    texBoxS = engine.loadTexture("assets/textures/ui/box/boxs.png")
    texBoxE = engine.loadTexture("assets/textures/ui/box/boxe.png")
    texBoxW = engine.loadTexture("assets/textures/ui/box/boxw.png")
    texBoxNE = engine.loadTexture("assets/textures/ui/box/boxne.png")
    texBoxNW = engine.loadTexture("assets/textures/ui/box/boxnw.png")
    texBoxSE = engine.loadTexture("assets/textures/ui/box/boxse.png")
    texBoxSW = engine.loadTexture("assets/textures/ui/box/boxsw.png")
