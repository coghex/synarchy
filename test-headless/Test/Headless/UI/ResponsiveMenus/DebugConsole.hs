...
--
--   #2027 extends the Settings-to-shell fan-out coverage; its cases
--   belong in the first group here, not in the menus owner.
...
import Test.Headless.UI.ResponsiveMenus.Fixture
  ( luaLines, newBareLuaBackend, evalOk, evalBool, evalInt, evalJSON
  , decodeProbe )
