...
MANUAL_ONLY_REASONS: dict[str, tuple[Reason, ...]] = {
    ...
    "construction": (Reason(SCENARIO_HEAVY, "long construct_job AI end-to-end scenario: "
                                            ...
                                            "solo runs (#724)"),),
    "location_content": (Reason(SCENARIO_HEAVY, "eleven real-engine-process scenario: ruin "
                                                ...
                                                "generated-language location naming with "
                                                "its own fresh-process reload, and #2505's "
                                                "pending container shells -- minted on first "
                                                "chunk load, not respawned on revisit, "
                                                "refusing an ordinary pickup, surviving "
                                                "save/quit/load, and a save whose slot names "
                                                "a deregistered profile refused before the "
                                                "replacement session is staged (#800 replaced "
                                                ...
                                                "owners out behind the probe's facade; #2505 "
                                                "added the container owner and its two "
                                                "closing phases)"),),
