...
PROTOCOL_PROBES: dict[str, str] = {
    ...
    "config_migration": probe_protocol.PROTOCOL_VERSION,
    "config_state": probe_protocol.PROTOCOL_VERSION,
    "crop": probe_protocol.PROTOCOL_VERSION,
    "disarm": probe_protocol.PROTOCOL_VERSION,
    "injury_log": probe_protocol.PROTOCOL_VERSION,
    "item_temp": probe_protocol.PROTOCOL_VERSION,
    ...
    "resource_root": probe_protocol.PROTOCOL_VERSION,
    "retaliation_swap": probe_protocol.PROTOCOL_VERSION,
    "river_naming": probe_protocol.PROTOCOL_VERSION,
    "role": probe_protocol.PROTOCOL_VERSION,
    "save_barrier": probe_protocol.PROTOCOL_VERSION,
    "save_pause": probe_protocol.PROTOCOL_VERSION,
