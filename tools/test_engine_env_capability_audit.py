...
def test_audit_against_the_real_repo():
    ...
    expect(len(live_fields) == 88,
           f"expected 88 live EngineEnv fields (issue #876's own count of 81, "
           ...
           f"#1712's `structureWallCatalogRef` and #1842's "
           f"`structureArtCatalogRef`), "
