...
SHIPPED_ROWS = [
    ...
    ("first_session_confront", ("Resolve a ruin encounter", 3)),
    ("first_session_recover", ("Recover significant loot", 4)),
    ("first_session_secure", ("Secure the recovered item", 5)),
    ("first_session_clear", ("Clear a location", 6)),
