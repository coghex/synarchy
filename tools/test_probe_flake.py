...
SEQUENCE = (
    ...
    ("migration", "config_migration", "TESTS"),
    ("migration", "resource_root", "TESTS"),
    ("migration", "retaliation_swap", "TESTS"),
    ("migration", "save_barrier", "TESTS"),
    ("migration", "save_pause", "TESTS"),
    ("migration", "pause_speed", "TESTS"),
    ("migration", "river_naming", "TESTS"),
