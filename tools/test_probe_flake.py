...
def test_manifest_real_registry() -> None:
    ...
    expect(migrated == ["position_hold", "role", "text_encoding",
                        "thermo_altitude"],
           f"position_hold, role, text_encoding and thermo_altitude are the "
           f"probe-result/v1 probes, in run_probes.PROBES order "
           f"(got {migrated})")
