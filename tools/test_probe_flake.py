...
def test_manifest_real_registry() -> None:
    ...
    expect(migrated == ["position_hold", "role", "thermo_altitude"],
           f"position_hold, role and thermo_altitude are the probe-result/v1 "
           f"probes, in run_probes.PROBES order (got {migrated})")
