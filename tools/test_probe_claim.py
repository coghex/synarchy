...
early and the other two run at the end, and two orchestration cases run
out of their own source order.
...
AGGREGATE_ORDER = (
    ...
    ("census", "test_owner_dependencies_run_one_way"),
